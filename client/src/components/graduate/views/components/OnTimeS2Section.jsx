...
import { OnTimeTooltipS2 } from './OnTimeTooltips';

export const OnTimeS2Section = ({ onTimeCohortDataS2 = [], onTimeChartDataS2 = [] }) => {
  if (onTimeCohortDataS2.length === 0) {
    return (
        ...
        <div className="h-64 w-full">
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={onTimeChartDataS2} margin={{ top: 10, right: 30, left: 0, bottom: 5 }}>
              ...
              <Bar dataKey="rate" name="% Tepat Waktu S2" fill="#7c3aed" radius={[4, 4, 0, 0]} barSize={32} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </div>
...
export default OnTimeS2Section;
