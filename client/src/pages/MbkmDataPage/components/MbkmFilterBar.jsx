...
import { STATUS_OPTIONS, JENJANG_OPTIONS } from '../hooks/useMbkmFilters';

export const MbkmFilterBar = ({
  searchTerm,
  setSearchTerm,
  timeHorizon,
  setTimeHorizon,
  ...
  return (
    <div className="bg-surface-container-lowest border border-surface-container-high rounded-xl p-4 sm:p-5 shadow-[0_1px_4px_rgba(0,0,0,0.03)] mb-2 space-y-4">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          ...
          <div className="inline-flex bg-surface-container-low p-1 rounded-lg border border-outline-variant/30 text-xs font-medium">
            ...
            >
              <span
                className={`w-2 h-2 rounded-full ${
                  timeHorizon === 'last5' ? 'bg-primary' : 'bg-outline-variant'
                }`}
              />
            ...
            >
              <span
                className={`w-1.5 h-1.5 rounded-full ${
                  timeHorizon === 'custom' ? 'bg-primary' : 'bg-outline-variant'
                }`}
              />
            ...
            >
              <span
                className={`w-1.5 h-1.5 rounded-full ${
                  timeHorizon === 'all' ? 'bg-primary' : 'bg-outline-variant'
                }`}
              />
              <span>All Time</span>
            </button>
      ...
      <div className="flex flex-col gap-3">
        {/* Row 1: Search Identifier, Fakultas, Program Studi */}
          ...
          <div className="md:col-span-2 relative">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="Search student name, NIM, or partner..."
                type="text"
              />
              {searchTerm && (
                <button
        ...
        {/* Row 2: Angkatan, Status Aktivitas, Jenjang */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <FilterMultiSelectDropdown
            id="filter-mbkm-angkatan-btn"
            label="Angkatan (Cohort)"
            placeholder="All Angkatan"
            options={availableAngkatans}
